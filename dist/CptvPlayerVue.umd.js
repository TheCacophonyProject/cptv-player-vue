...
;// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"ad69aec0-vue-loader-template"}!./node_modules/vue-loader-v15/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ruleSet[0].rules[0].use[0]!./node_modules/vue-loader-v15/lib/index.js??vue-loader-options!./src/CptvPlayer.vue?vue&type=template&id=f3a623e0&
...
// EXTERNAL MODULE: ./node_modules/cptv-decoder/decoder.worker.js
var decoder_worker = __webpack_require__(1329);
...
class CptvDecoder {
  constructor() {
    ...
    if (typeof window === "undefined") {
      this.decoder = new worker_threads_ignored_.Worker(new URL(/* worker import */ __webpack_require__.p + __webpack_require__.u(329), __webpack_require__.b));
      this.decoder.addListener.bind(this.decoder)("message", onMessage);
    } else {
      this.decoder = new decoder_worker/* default */.Z();
...
;// CONCATENATED MODULE: ./node_modules/worker-loader/dist/cjs.js!./src/mp4-exporter.js
function Worker_fn() {
  return new Worker(__webpack_require__.p + "CptvPlayerVue.umd.worker.js");
}
  ...
  _createClass(CptvPlayerComponent, [{
    ...
    value: function created() {
      ...
      if (palettePreference) {
        this.paletteIndex = ColourMaps.findIndex(function (_ref) {
    ...
    key: "minMaxForFrame",
    value: function minMaxForFrame(_ref3) {
      var meta = _ref3.meta;
                  ...
                  try {
                    for (_iterator.s(); !(_step = _iterator.n()).done;) {
                      ...
                      if (includeInExportTime) {
                        ...
                        startFrame = Math.min(startFrame, this.getFrameAtTime(track.data.start_s - 1));
                        onePastLastFrame = Math.max(onePastLastFrame, this.getFrameAtTime(track.data.end_s + 1));
                      }
                    }
                  } catch (err) {
                    _iterator.e(err);
...
/* harmony export */   "Z": () => (/* binding */ Worker_fn)
/* harmony export */ });
function Worker_fn() {
  return new Worker(__webpack_require__.p + "decoder.worker.fdcb82445d0f20be968b.worker.js");
}
...
/******/ 	var __webpack_exports__ = __webpack_require__(9051);
